...
exports.default = function (tasks, concurrency, callback) {
    ...
    function addListener(goalName, fn) {
        var taskListeners = listeners[goalName];
        if (!taskListeners) {
            taskListeners = listeners[goalName] = [];
        }

        taskListeners.push(fn);
    }

    function taskComplete(goalName) {
        var taskListeners = listeners[goalName] || [];
    ...
    function getDependents(goalName) {
        var result = [];
        (0, _baseForOwn2.default)(tasks, function (task, key) {
            if ((0, _isArray2.default)(task) && (0, _baseIndexOf2.default)(task, goalName, 0) >= 0) {
                result.push(key);
            }
        });
        return result;
